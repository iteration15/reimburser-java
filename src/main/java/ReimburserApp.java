...
public class ReimburserApp {
	...
	public static void main(String[] args) {
		...
		LocalDate startDate2 = LocalDate.parse("2015-09-01");
		LocalDate endDate2 = LocalDate.parse("2015-09-01");
		
		LocalDate startDate3 = LocalDate.parse("2015-09-01");
		LocalDate endDate3 = LocalDate.parse("2015-09-01");		
		
		LocalDate startDate4 = LocalDate.parse("2015-09-02");
		LocalDate endDate4 = LocalDate.parse("2015-09-02");	
		
		LocalDate startDate5 = LocalDate.parse("2015-09-02");
		LocalDate endDate5 = LocalDate.parse("2015-09-03");			
